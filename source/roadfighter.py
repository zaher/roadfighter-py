...
class RoadFighter:
    def __init__(self, start_level: int = 1, level_type: str | None = None, record_replay: bool = False, load_replay: bool = False) -> None:
        ...
        self.retroremakes_sfc = _load_surface("graphics/retroremakes.png")
        ...
        self.arrow_sfc = _load_surface("graphics/arrow.png")
        self.scoreboard_sfc = _load_surface("graphics/scoreboard.png")
        self.scoreboard2_sfc = None
        self.scoreboardleft_sfc = _load_surface("graphics/scoreboard_left.png")
        self.gamemap_sfc = _load_surface("graphics/gamemap.png")
        self.minicar1_sfc = _load_surface("graphics/minicar1.png")
        self.minicar2_sfc = _load_surface("graphics/minicar2.png")
